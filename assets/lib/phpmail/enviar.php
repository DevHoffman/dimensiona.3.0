...
$_SESSION['TituloMensagem'] = "Mensagem enviada!";
$_SESSION['Mensagem'] = "Sua mensagem foi enviada à gerência!";

mysqli_close($ligacao);

header('location: /administrativo/page-fale-com-gerencia.php');
exit;
